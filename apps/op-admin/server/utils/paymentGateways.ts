...
const sxjzszConfig = {
    ...
    pid: '100181',
    md5Key: 'gKYMtZYoKVGwGfqPdmqqpFTw98BbxGpH'
};
...
// Provider: 众合支付（ZhongHe Pay / 合众支付）
// 商户号: M1779271822，通道: 微信8888 / 支付宝9999
...
const zhonghePayConfig = {
    ...
    mchId: 'M1779271822',
    md5Key: 'hmcox0zh8hrykqqeo8yi6i6f5o9g0q0n'
};
...
const zhonghePayProvider: PaymentProvider = {
    ...
    async query(req: QueryOrderRequest, creds?: Record<string, any>): Promise<QueryOrderResponse> {
        ...
        try {
            ...
            return { code: -1, msg: result.msg || '询单失败' };
        } catch (error: any) {
            return { code: -1, msg: `查询异常: ${error.message}` };
        }
    }
...
export const gatewayParamSets: Record<string, GatewayParamSet & { supportQuery?: boolean; isOpen?: boolean; name?: string; remark?: string }> = {
    ...
    '5': {
        ...
        name: '贝宝支付5%',
        remark: '贝宝支付 pid=100181 账户名:WarOrder777 单笔限额:2000元',
        supportQuery: false,
        isOpen: true,
        credentials: {
            baseUrl: 'https://payment.sxjzsz.com/v1/pay/create',
            pid: '100181',
            accountName: 'WarOrder777',
            password: 'Wo#2026King',
            limitAmount: 2000,
            md5Key: 'gKYMtZYoKVGwGfqPdmqqpFTw98BbxGpH'
        }
    },
    ...
    // payment=7 接入众合支付（ZhongHe Pay / 合众支付）
    // 商户号: M1779271822，通道: 微信8888 / 支付宝9999
    '7': {
        providerKey: 'zhonghePay',
        name: '合众支付',
        remark: '合众支付 (众合支付) 商户号:M1779271822 登录账号:zhyzx888',
        supportQuery: true,
        isOpen: true,
        credentials: {
            baseUrl: 'https://ai2hgfrfpay.zzisadaksjdkhflkalsd.xyz/Pay_Index',
